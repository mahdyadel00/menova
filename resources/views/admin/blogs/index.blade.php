...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">@lang('blogs.blogs')</li>
    </ul>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if (auth()->user()->hasPermission('create_blogs'))
                            <a href="{{ route('admin.blogs.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.create')</a>
                        @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table datatable" id="blogs-table" style="width: 100%;">
                                <thead>
                                <tr>
                                    <th>
                                    ...
                                    <th>@lang('blogs.title')</th>
                                    <th>@lang('blogs.domain')</th>
                                    <th>@lang('blogs.user')</th>
