...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">@lang('domains.domains')</li>
    </ul>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if (auth()->user()->hasPermission('read_domains'))
                            <a href="{{ route('admin.domains.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.create')</a>
                        @endif

                        @if (auth()->user()->hasPermission('delete_domains'))
                            <form method="post" action="{{ route('admin.domains.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
