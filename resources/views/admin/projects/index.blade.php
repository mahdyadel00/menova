...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">@lang('projects.projects')</li>
    </ul>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if (auth()->user()->hasPermission('create_projects'))
                            <a href="{{ route('admin.projects.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.create')</a>
                        @endif
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table datatable" id="projects-table" style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <th>@lang('projects.title')</th>
                                    <th>@lang('projects.domain')</th>
                                    <th>@lang('projects.project_type')</th>
