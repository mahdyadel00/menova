...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.topics.index') }}">@lang('topics.topics')</a></li>
                        ...
                        <div class="tab-pane fade show {{$index == 0 ? 'active' : ''}} pt-2" id="{{$locale}}">
                            ...
                            <div class="form-group">
                                @php
                                    $input = 'name';
                                @endphp
                                <label>@lang('topics.'.$locale.'.'.$input)<span class="text-danger">*</span></label>
                                <input type="text" name="{{$locale.'_'.$input}}" class="form-control" 
                                value="{{ old($locale.'_'.$input, $topic->translate($locale)->{$input}) }}" required autofocus>
