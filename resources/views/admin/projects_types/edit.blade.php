    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('admin.project-types.update', $project_type->id) }}">
                    @csrf
                    @method('put')
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show {{$index == 0 ? 'active' : ''}} pt-2" id="{{$locale}}">
                            ...
                            <div class="form-group">
                                ...
                                value="{{ old($locale.'_'.$input, $project_type->translate($locale)->{$input}) }}" required autofocus>
