                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        {{-- @if (auth()->user()->hasPermission('create_contacts'))
                            <a href="{{ route('admin.contacts.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.create')</a>
                        @endif --}}

                        @if (auth()->user()->hasPermission('delete_contacts'))
                            <form method="post" action="{{ route('admin.contacts.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
...
@push('scripts')
    ...
    <script>
        ...
        let usersTable = $('#contacts-table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
