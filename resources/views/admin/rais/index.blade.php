...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">@lang('rais.rais')</li>
    </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table datatable" id="rais-table" style="width: 100%;">
                                <thead>
                                <tr>
                                    <th>
...
@push('scripts')
    ...
    <script>
        ...
        let usersTable = $('#rais-table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
