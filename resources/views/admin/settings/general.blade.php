            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('admin.settings.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ Storage::url('uploads/images/' . setting('logo')) }}" class="loaded-image" alt="" style="display: {{ setting('logo') ? 'block' : 'none' }}; width: 100px; margin: 10px 0;">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ Storage::url('uploads/images/' . setting('fav_icon')) }}" class="loaded-image" alt="" style="display: {{ setting('fav_icon') ? 'block' : 'none' }}; width: 50px; margin: 10px 0;">
                    </div>
