...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">@lang('services.services')</li>
    </ul>
            ...
            <div class="tile shadow">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                            ...
                            <a href="{{ route('admin.services.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.create')</a>
...
@push('scripts')
    ...
    <script>
        ...
        let usersTable = $('#services-table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
