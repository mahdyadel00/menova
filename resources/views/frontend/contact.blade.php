                    ...
                    <div class="col-md-4">
                        <div class="contact-icon text-center">
                            <div class="single-icon">
                                ...
                                <p>
                                    @lang('site.call'): +1 5589 55488 55<br>
                    ...
                    <div class="col-md-4">
                        <div class="contact-icon text-center">
                            <div class="single-icon">
                                ...
                                <p>
                                    @lang('site.email'): info@example.com<br>
                    ...
                    <div class="col-md-4">
                        <div class="contact-icon text-center">
                            <div class="single-icon">
                                ...
                                <p>
                                    @lang('site.location'): A108 Adam Street<br>
                            ...
                            <form action="{{ route('contacts.store')}}" method="post" role="form" class="php-email-form">
                                ...
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control" id="name"
                                        placeholder="@lang('site.your_name')" required>
                                </div>
                                <div class="form-group mt-3">
                                    <input type="email" class="form-control" name="email" id="email"
                                        placeholder="@lang('site.your_email')" required>
                                </div>
                                <div class="form-group mt-3">
                                ...
                                <div class="form-group mt-3">
                                    <textarea class="form-control" name="message" rows="5" placeholder="@lang('site.message')" required></textarea>
                                </div>
                                <div class="my-3">
