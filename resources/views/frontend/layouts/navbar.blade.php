<nav id="navbar" class="navbar">
    <ul>
        ...
        href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">@lang('front.language')</a>
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li class="dropdown-item"> <a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                                                          document.getElementById('logout-form').submit();" class="nav-link">@lang('site.logout')</a>
