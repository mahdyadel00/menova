    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-info">
                <a href="/"><img src="{{URL::asset('frontend/assets/img/logo.png')}}" alt="logo" class="img-fluid" style="width:320px"></a>

          {{-- <a href="http://menovahub.com" class="logo d-flex align-items-center"> --}}
            {{-- <img src="{{ asset('frontend') }}/assets/img/logo.jpeg" alt="">
            <span>@lang('site.menovahub')</span> --}}
          </a>
