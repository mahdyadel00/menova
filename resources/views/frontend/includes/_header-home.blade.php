	...
	<div class="top-header-area" id="sticker" style="height: 82px;background: #ffffff;">
		<div class="container">
			<div class="col-12">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								<li>
                <a href="{{ route('frontend.user_home') }}">@lang('site.home')</a>
								</li>
								<li><a href="#connect" class="dropdown-toggle">@lang('site.connect')</a> 
									<ul class="sub-menu">
								...
								<li><a href=""class="dropdown-toggle">@lang('site.educate')</a>
									<ul class="sub-menu">
										<li><a href="shop.html">@lang('site.find_an_investor')</a></li>
									</ul>
								</li> -->
								...
								<li >
										<a class=" btn-pink btn " data-toggle="button" aria-pressed="false" href="{{ route('frontend.get_premium.index') }}">

											@lang('site.get_premium')
										</a>
								</li>
								<li>
                ...
                @auth
								<li><a href="#" class="dropdown-toggle"><i class="fa fa-user"></i> {{ auth()->user()->name ?? auth()->user()->email  }}</a> 
									<ul class="sub-menu">
